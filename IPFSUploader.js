...
class IPFSUploader extends React.Component {
    ...
    onSubmit = async (event) => {
        ...
        try {
            await this.props.state.contract.addFile([this.state.title, this.state.fileName, this.state.fileType], this.state.cid, {from: this.props.state.account, gas: 20000000});
        } catch(e) {
